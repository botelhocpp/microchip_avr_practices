...
const uint16_t gpio_port_registers[] = {PORTB_ADDR, PORTC_ADDR, PORTD_ADDR};
const uint16_t gpio_ddr_registers[] = {DDRB_ADDR, DDRC_ADDR, DDRD_ADDR};
const uint16_t gpio_pin_registers[] = {PINB_ADDR, PINC_ADDR, PIND_ADDR};
